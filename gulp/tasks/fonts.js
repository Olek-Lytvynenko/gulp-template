...
export const otfToTtf = () => {
  return global.global.app.gulp
    .src(`${global.app.path.srcFolder}/fonts/*.otf`, {})
    .pipe(
      global.app.plugins.plumber(
...
export const ttfToWoff = () => {
  return global.app.gulp
    .src(`${global.app.path.srcFolder}/fonts/*.ttf`, {})
    .pipe(
      global.app.plugins.plumber(
        global.app.plugins.notify.onError({
          title: "FONTS",
  ...
  fs.readdir(global.app.path.build.fonts, function (err, fontsFiles) {
    if (fontsFiles) {
      if (!fs.existsSync(fontsFile)) {
        ...
        console.log("The file already exists. To update the file, delete it.");
      }
    }
  });
